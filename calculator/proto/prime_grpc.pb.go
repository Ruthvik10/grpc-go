...
func (x *primeServicePrimeClient) Recv() (*PrimeReponse, error) {
	m := new(PrimeReponse)
...
func (x *primeServicePrimeServer) Send(m *PrimeReponse) error {
