...
func (x *PrimeReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrimeReponse) ProtoMessage() {}

func (x *PrimeReponse) ProtoReflect() protoreflect.Message {
	mi := &file_prime_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrimeReponse.ProtoReflect.Descriptor instead.
func (*PrimeReponse) Descriptor() ([]byte, []int) {
	return file_prime_proto_rawDescGZIP(), []int{1}
}

func (x *PrimeReponse) GetResult() int32 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_prime_proto_rawDesc = []byte{
	...
	,
...
var file_prime_proto_goTypes = []interface{}{
	...
	(*PrimeReponse)(nil), // 1: prime.PrimeReponse
}
var file_prime_proto_depIdxs = []int32{
	0, // 0: prime.PrimeService.Prime:input_type -> prime.PrimeRequest
	1, // 1: prime.PrimeService.Prime:output_type -> prime.PrimeReponse
